...
public class GreaterThanEquals extends BaseCondition {

	
	
	public GreaterThanEquals(AttributeIF attr1, AttributeIF attr2) {
		super(attr1, attr2);

	}

	public GreaterThanEquals(String attrStr1, String attrStr2) {
